...
<body id="page-top">
    <nav class="navbar navbar-dark navbar-expand-lg fixed-top bg-dark" id="mainNav">
        <div class="container"><a class="navbar-brand" href="#page-top">FaceID</a><button class="navbar-toggler navbar-toggler-right" data-toggle="collapse" data-target="#navbarResponsive" type="button" data-toogle="collapse" aria-controls="navbarResponsive" aria-expanded="false" aria-label="Toggle navigation"><i class="fa fa-bars"></i></button>
    ...
    <?php $results = mysqli_query($link, "SELECT * FROM model_requests WHERE type='0'"); ?>
    <!--type = 0,if model is not uploaded-->
            ...
            <?php while ($row = mysqli_fetch_array($results)) { ?>
                ...
                <tr>
                    ...
                    <form method="post" action="UploadModel.php">
                        <input type="hidden" name="srno" id="srno" value="<?php echo $row['srno']; ?>" />
                        <td style="padding:10px;padding-left:30px;padding-right:30px; text-align:center"><button class="btn btn-secondary" name="upload_btn" type="submit">Upload 3D Model </button></td>
                    </form>
                </tr>
