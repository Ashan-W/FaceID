...
<?php
    ...
    <?php
        ...
        <tbody>
            <tr>
                <th scope="row">FacialPhotograph</th>
            ...
            <tr>
                <th scope="row">DNA</th>
                <td> <?php echo "<img src ='data:image/jpg;base64," . base64_encode($b) ."' alt = ''/ width=100px height=100px> ";?> </td>
            </tr>
            <tr>
                <th scope="row">Fingerprint</th>
                <td> <?php echo "<img src ='data:image/jpg;base64," . base64_encode($c) ."' alt = ''/ width=100px height=100px> ";?> </td>
            </tr>
            <tr>
                <th scope="row">Dental</th>
                <td> <?php echo "<img src ='data:image/jpg;base64," . base64_encode($d) ."' alt = ''/ width=100px height=100px> ";?> </td>
            </tr>
            <tr>
