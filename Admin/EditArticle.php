        ...
        <div class="d-flex justify-content-center form-group" style="padding:60px">
            ...
            <table class="table-dark table-striped" style="border:1px solid black;margin-left:auto;margin-right:auto;">
                ...
                <tr>
                    ...
                    <td style="text-align:center"  width="600px"> <input type="text" class="rounded"  style="width:95%;border:none;border:1px solid white;background-color:transparent;color:white;" name="article" size="500" value="<?php echo $row['article'];?>"></td>
                </tr>
                <tr>
                    <th style="padding:20px;text-align:center" width="200px"></th>
                    <input type="hidden" name="id" id="id" value="<?php echo $row['id']; ?>">
                    <td style="text-align:center"  width="600px"> <button class="btn btn-secondary" name="editArti" formmethod="post" type="submit">Update</td>
                </tr>
            </table>
        </div>    
    </form>
