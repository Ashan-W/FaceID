            ...
            <div class="d-flex justify-content-center form-group" style="padding:60px">
                <table class=" table1 table-dark table-striped">
                    <tr>
                        ...
                        <td width="600px"> <?php echo $row['id']; ?>
                        <td>
                    </tr>
                    <tr>
                        <th width="200px">Date</th>
                        <td width="600px"> <?php echo $row['date']; ?>
                        <td>
                    </tr>
                    <tr>
                        <th width="200px">Article</th>
                        <td width="600px"> <textarea rows="10" class="rounded" name="article" size="500" value="<?php echo $row['article']; ?>"><?php echo $row['article']; ?></textarea></td>
                    </tr>
                    <tr>
                        <th width="200px"></th>
                        <input type="hidden" name="id" id="id" value="<?php echo $row['id']; ?>">
                        <td width="600px"> <button onclick="myFunction()" class="btn btn-secondary" name="editArti" formmethod="post" type="submit">Update</td>
                    </tr>
                </table>
            </div>
        </form>
