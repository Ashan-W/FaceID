...
<nav class="navbar navbar-dark navbar-expand-lg fixed-top bg-dark" id="mainNav">
    ...
    <form class="form d-flex-justify" method="post" action="AddDetails.php" style="margin-top:100px;">
        <div class="box fluid d-flex-justify">
            <caption>
            ...
            <div class="form-group">
                ...
                <select name="province" class="inputSelect form-control" style="width: 403px">
            ...
            <div class="form-group">
                ...
                <select class="inputSelect form-control" name="district" style="width: 403px">
            ...
            <div class="form-group">
                <label>DNA: </label>
                <input type="file" class="form-control-file" name="dna" accept="image/*" style="width:300px;"></div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label>Special Remarks<label>
                        <textarea class="form-control" name="specialremarks" style="width:400px;height: 120px"></textarea>
            </div>
            <div class="form-group">
                <button class="btn btn-secondary" name="adddet" type="submit">
            </div>
        </div>
    </form>
